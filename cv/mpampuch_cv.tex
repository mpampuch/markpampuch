...
\section*{SKILLS}
\noindent
\textbf{Programming:} Python, R, Bash/Linux Shell, JavaScript, Java, Groovy, SQL, \LaTeX\ % Related Programming languages those can be helpful; comma separated

\noindent
\textbf{Technologies:} PyTorch, Nextflow, SLURM, Docker, Singularity, Anaconda, Git % Related Technologies languages those can be helpful; comma separated

\noindent
\textbf{Software:} Visual Studio Code, RStudio, Microsoft Excel, IGV, Geneious, Benchling, SnapGene % Related software those can be helpful; comma separated
...
% \begin{minipage}{1\textwidth}
	% \setlength{\parindent}{15pt} % Default is 15pt
		...
		% \textit{Issued by Todd Shannon (\#10986)} | Credential ID:  A95B424 
	% \end{minipage}
	...
	% \begin{minipage}{1\textwidth}
		...
		% \noindent
		% NAUI Drysuit Diver \\
		% \textit{Issued by Todd Shannon (\#10986)} | Credential ID:  89B2F8A 
	% \end{minipage}
